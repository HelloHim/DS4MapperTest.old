namespace DS4MapperTest
{
    public class SendInputMapping : VirtualKBMMapping
    {
        public override void PopulateConstants()
        {
            ...
            MOUSEEVENTF_XBUTTON1DOWN = MOUSEEVENTF_XBUTTONDOWN;
            MOUSEEVENTF_XBUTTON1UP = MOUSEEVENTF_XBUTTONUP;
            MOUSEEVENTF_XBUTTON2DOWN = MOUSEEVENTF_XBUTTONDOWN;
            MOUSEEVENTF_XBUTTON2UP = MOUSEEVENTF_XBUTTONUP;
            MOUSEEVENTF_XBUTTON1DATA = 1;
            MOUSEEVENTF_XBUTTON2DATA = 2;
