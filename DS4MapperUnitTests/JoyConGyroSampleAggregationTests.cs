...
{
    [TestClass]
    public class JoyConGyroSampleAggregationTests
    {
        [TestMethod]
        public void SingleMeaningfulSample_ProducesSameMagnitudeAsThatSample()
        {
            ...
            short combined = JoyConReader.CombineGyroAxisSamples(gyroOut, 1,
        ...
        public void YawAxis_AppliesNegationAndCalibOffsetSignAcrossAllSamples()
        {
            ...
            short combinedYaw = JoyConReader.CombineGyroAxisSamples(gyroOut, 0,
                bias: 50, calibOffset: 20, negate: true, calibOffsetSign: 1);
            short combinedPitch = JoyConReader.CombineGyroAxisSamples(gyroOut, 0,
        ...
        public void RollAxis_IsIndependentOfYawAndPitchOffsets()
        {
            ...
            short combinedRoll = JoyConReader.CombineGyroAxisSamples(gyroOut, 2,
