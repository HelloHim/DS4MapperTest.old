...
{
    [TestClass]
    public class SwitchProStickCalibrationTests
    {
        [TestMethod]
        public void AxisAtAssumedMidpoint_NoCalibrationChangeApplied()
        {
            var axisData = new SwitchProDevice.StickAxisData { min = 548, mid = 2048, max = 3548 };

            bool calibUpdated = SwitchProReader.AdjustStickAxisCalibration(ref axisData, 2048);
        ...
        public void AxisAboveAssumedMidpoint_ShiftsCentreAndScalesRangeSymmetrically()
        {
            ...
            bool calibUpdated = SwitchProReader.AdjustStickAxisCalibration(ref axisData, 2148);
        ...
        public void AxisBelowAssumedMidpoint_ShiftsCentreAndScalesRangeSymmetrically()
        {
            ...
            bool calibUpdated = SwitchProReader.AdjustStickAxisCalibration(ref axisData, 1948);
        ...
        public void AsymmetricStartingRange_PreservesRelativeAsymmetryOnUpwardShift()
        {
            ...
            var axisData = new SwitchProDevice.StickAxisData { min = 0, mid = 2048, max = 3600 };
        ...
        {
            var axisData = new SwitchProDevice.StickAxisData { min = 400, mid = 2048, max = 4096 };
            int belowGap = axisData.mid - axisData.min;
            int aboveGap = axisData.max - axisData.mid;
