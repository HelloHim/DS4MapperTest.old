...
namespace DS4MapperUnitTests
{
    ...
    public class TouchpadPressureDualStageActionTests
    {
        ...
        public void Defaults_MatchSpec()
        {
            ...
            Assert.AreEqual(13096, action.FullPressThreshold);
        ...
        public void Touch_WithSufficientPressure_ActivatesSoftThenFull()
        {
            ...
            action.PrepareTouchpadPressure(mapper, 5000, touched: true); // above soft(4096), below full(13096)
            Assert.IsTrue(action.softPressActActive);
            Assert.IsFalse(action.fullPressActActive);

            action.PrepareTouchpadPressure(mapper, 20000, touched: true); // above full(13096)
            Assert.IsTrue(action.softPressActActive);
